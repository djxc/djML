# -*- coding: utf-8 -*-
"""
Created on Wed Jan 29 18:54:49 2020
...
def createPwBook():
    ...
    r = ite.product(words, repeat=8)
    dic = open(r"D:\2020\python\pw.txt", "a")
    for i in r:
        dic.write("".join(i) + "\n")
    dic.close()

if __name__ == "__main__":
#    path=r"D:\2020\python\pw.txt"
#    start=PoJie(path)
#    start.readPassWord()
    createPwBook()