...
def vgg11(**kwargs):
    model = VGGModel(make_layers(cfg['A']), **kwargs)
    return model


def vgg11_bn(**kwargs):
    model = VGGModel(make_layers(cfg['A'], batch_norm=True), **kwargs)
    return model


def vgg13(**kwargs):
    model = VGGModel(make_layers(cfg['B']), **kwargs)
    return model


def vgg13_bn(**kwargs):
    model = VGGModel(make_layers(cfg['B'], batch_norm=True), **kwargs)
    return model


def vgg16(**kwargs):
    model = VGGModel(make_layers(cfg['D']), **kwargs)
    return model


def vgg16_bn(**kwargs):
    model = VGGModel(make_layers(cfg['D'], batch_norm=True), **kwargs)
    return model


def vgg19(**kwargs):
    model = VGGModel(make_layers(cfg['E']), **kwargs)
    return model


def vgg19_bn(**kwargs):
    model = VGGModel(make_layers(cfg['E'], batch_norm=True), **kwargs)
    return model
...
def createResNet(in_channels, out_class):
    net = nn.Sequential(
    ...
    net.add_module("fc", nn.Sequential(FlattenLayer(), nn.Linear(512, out_class)))
    return net
