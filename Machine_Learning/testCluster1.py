...
IMAGE_PIXELS = 28
# 定义默认训练参数和数据路径
flags.DEFINE_string('data_dir', '/tmp/data', 'Directory  for storing mnist data')
...
flags.DEFINE_string('ps_hosts', '121.248.96.53:22221', 'Comma-separated list of hostname:port pairs')
# 两个worker节点
flags.DEFINE_string('worker_hosts', '121.248.96.53:22222',      #121.248.96.97:22221
